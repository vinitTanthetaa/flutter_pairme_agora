                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          _selectedimag1?.selectedFile != null
                              ? Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      _selectedimag1!.selectedFile.path
                                              .endsWith(".mp4")
                                          ? video(
                                              videoPath:
                              ...
                              : Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      widget.image1.endsWith(".mp4")
                                          ? networkVideo(
                                              url:
                                                  '${apis.baseurl}/${widget.image1}',
                                            )
                                          : CachedNetworkImage(
                                              imageUrl:
                                                  '${apis.baseurl}/${widget.image1}',
                          ...
                          _selectedimag2?.selectedFile != null
                              ? Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      _selectedimag2!.selectedFile.path
                                              .endsWith(".mp4")
                                          ? video(
                                              videoPath:
                                                  _selectedimag2!.selectedFile,
                              ...
                              : Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      widget.image2.endsWith(".mp4")
                                          ? networkVideo(
                                              url:
                                                  '${apis.baseurl}/${widget.image2}',
                                            )
                                          : CachedNetworkImage(
                                              imageUrl:
                                                  '${apis.baseurl}/${widget.image2}',
                          ...
                          _selectedimag3?.selectedFile != null
                              ? Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      _selectedimag3!.selectedFile.path
                                              .endsWith(".mp4")
                                          ? video(
                                              videoPath:
                              ...
                              : Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      widget.image3.endsWith(".mp4")
                                          ? networkVideo(
                                              url:
                                                  '${apis.baseurl}/${widget.image3}',
                                            )
                                          : CachedNetworkImage(
                                              imageUrl:
                                                  '${apis.baseurl}/${widget.image3}',
                        ...
                        children: [
                          _selectedimag4?.selectedFile != null
                              ? Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      _selectedimag4!.selectedFile.path
                                              .endsWith(".mp4")
                                          ? video(
                                              videoPath:
                              ...
                              : Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      widget.image4.endsWith(".mp4")
                                          ? networkVideo(
                                              url:
                                                  '${apis.baseurl}/${widget.image4}',
                                            )
                                          : CachedNetworkImage(
                                              imageUrl:
                                                  '${apis.baseurl}/${widget.image4}',
                          ...
                          _selectedimag5?.selectedFile != null
                              ? Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      _selectedimag5!.selectedFile.path
                                              .endsWith(".mp4")
                                          ? video(
                                              videoPath:
                              ...
                              : Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      widget.image5.endsWith(".mp4")
                                          ? networkVideo(
                                              url:
                                                  '${apis.baseurl}/${widget.image5}',
                                            )
                                          : CachedNetworkImage(
                                              imageUrl:
                                                  '${apis.baseurl}/${widget.image5}',
                          ...
                          _selectedimag6?.selectedFile != null
                              ? Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      _selectedimag6!.selectedFile.path
                                              .endsWith(".mp4")
                                          ? video(
                                              videoPath:
                              ...
                              : Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      widget.image6.endsWith(".mp4")
                                          ? networkVideo(
                                              url:
                                                  '${apis.baseurl}/${widget.image6}',
                                            )
                                          : CachedNetworkImage(
                                              imageUrl:
                                                  '${apis.baseurl}/${widget.image6}',
                                                                                    ...
                                                                                    children: [
                                                                                      GestureDetector(
                                                                                        ...
                                                                                        child: Container(
                                                                                          ...
                                                                                          child: const Text(
                                                                                            'Cancel',
                                                                                            style: TextStyle(fontFamily: 'Roboto', fontSize: 15, fontWeight: FontWeight.w600, color: AppColor.skyBlue),
                                                                                          ),
                                                                                        ),
                                                                                      ),
                                                                                      GestureDetector(
                                                                                        ...
                                                                                        child: Container(
                                                                                          ...
                                                                                          child: const Text(
                                                                                            'Remove',
                                                                                            style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, fontFamily: 'Roboto', color: AppColor.white),
                                                                                          ),
                                                                                        ),
                                                                                      )
                                                                                    ],
                                                                            ...
                                                                            SimpleDialog(
                                                                              ...
                                                                              children: [
                                                                                const Padding(
                                                                                  padding: EdgeInsets.symmetric(horizontal: 35),
                                                                                  child: Text(
                                                                                    'Are you sure you want to remove file1?',
                                                                                    textAlign: TextAlign.center,
                                                                                    maxLines: 2,
                                                                                    style: TextStyle(color: AppColor.black, fontWeight: FontWeight.w500, fontSize: 15, fontFamily: 'Roboto'),
                                                                                  ),
                      ...
                      BlocBuilder<BusinessprofileupdateCubit,
                          BusinessprofileupdateState>(
