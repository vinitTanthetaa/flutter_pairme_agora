...
class _PremiumMembershipState extends State<PremiumMembership> {
  List data = [
    {'month' : '1 Month','ruppy':'\$413.85/per month','des':'Unlock all of our features to be in completecontrol of your experience'},
    {'name' : 'popular','month' : '6 Month','ruppy':'\$273.35/month','save':'Save 40%','des':'Unlock all of our features to be in completecontrol of your experience'},
    {'name' : 'Best value','month' : '12 Month','ruppy':'\$207.35/month','save':'Save 40%','des':'Unlock all of our features to be in completecontrol of your experience'}
  ];
  @override
                ...
                child: SafeArea(
                  child: Column(
                    ...
                    children: [
                        ...
                        child: ListView.builder(
                          ...
                          return  Center(
                            child: InkWell(
                              ...
                              child: Container(
                                margin: EdgeInsets.only(right: screenWidth(context,dividedBy: 50)),
                                height: screenHeight(context, dividedBy: 5.28),
                                width: screenWidth(context, dividedBy: 1.17),
                                decoration: BoxDecoration(
                                    color: AppColor.white,
                                    borderRadius: BorderRadius.circular(23),
                                    gradient: data[index] == 0 ? LinearGradient(colors: [AppColor.skyBlue,Color(0xff6D9AFF)] ,begin: Alignment.topLeft,end: Alignment.bottomRight) : LinearGradient(colors: [Color(0xff2468FF),Color(0xff5BC8FF)] ,begin: Alignment.topLeft,end: Alignment.bottomRight),
                                    boxShadow: const [
                                      BoxShadow(
                                        color: Colors.grey,
                                        offset: Offset(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      SizedBox(height:data[index]['save'] != null ? screenHeight(context,dividedBy: 200) : 0,),
                                      data[index]['save'] != null ?Text('Save 40%',style: TextStyle(fontSize: 10,fontWeight: FontWeight.w500,fontFamily: 'roboto',color: AppColor.white)): const SizedBox(),
                                      data[index]['ruppy'] != null ? Container(
                                        margin: EdgeInsets.only(top: screenHeight(context,dividedBy: 100)),
                                        ...
                                        child: Text(data[index]['ruppy'],style: TextStyle(fontSize: 10,fontWeight: FontWeight.w500,fontFamily: 'roboto',color: AppColor.black)),
                                      ) : const SizedBox(),
                                    ],
                                  ),
                                ),
                      ...
                      Padding(
                        padding: EdgeInsets.only(left: screenWidth(context,dividedBy: 25),right: screenWidth(context,dividedBy: 15)),
                        child: Row(
